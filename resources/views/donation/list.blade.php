                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    @if(isset($prefecture) && count($cafes) !== 0)
                        <div class="flex items-center mb-6">
                            ...
                            <p class="text-2xl font-bold">{{ $prefecture }}の寄付先保護猫カフェ一覧</p>
                        </div>
                        <p class="leading-loose">
                            Amazonほしいものリストから物資を寄付できる保護猫カフェを表示します。
                            <br>
                    ...
                    @elseif(count($cafes) !== 0)
                        <div class="flex items-center mb-6">
                            <div class="h-10 w-1 bg-orange-300 mr-4"></div>
                            <p class="text-2xl font-bold">全ての寄付先保護猫カフェ一覧</p>
                        </div>
                        <p class="leading-loose">
                            Amazonほしいものリストから物資を寄付できる保護猫カフェを表示します。
                            <br>
                    ...
                    @else
                        <p class="text-red-500 my-4">「{{ $prefecture }}」の寄付先の保護猫カフェは未登録でした。他の県を選択してください。</p>
                    @endif
                    
                    <form action="{{ route('donation.list') }}" method="GET">
                            ...
                            <table class="my-4">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left bg-orange-50 dark:bg-gray-600 px-8 border-b">Amazonほしいものリスト</th>
                                    </tr>
                                </thead>
                                <tbody>
                            ...
                            <table class="my-4">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left bg-orange-50 dark:bg-gray-600 px-2 border-b">Amazonほしいものリスト</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach ($cafes as $cafe)
